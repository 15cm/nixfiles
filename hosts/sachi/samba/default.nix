...
with lib;
{
  ...
  services.samba = {
    ...
    settings = {
      ...
      "main-music" = {
        path = "/pool/main/media/music";
      };
      "main-picture" = {
        path = "/pool/main/media/picture";
      };
      "main-photo" = {
        path = "/pool/main/media/photo";
      };
      "main-book" = {
      ...
      "sub-aria2-baidu" = {
        path = "/pool/sub/download/aria2-baidu";
      };
      "sub-arr" = {
        path = "/pool/sub/arr";
      };
      ...
      "sub-download" = {
        path = "/pool/sub/download";
      };
      "sub-tvshow" = {
        path = "/pool/sub/media/tvshow";
      };
      "sub-movie" = {
        path = "/pool/sub/media/movie";
      };
    };
  };
