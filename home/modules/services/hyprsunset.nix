...
in
{
  options.my.services.hyprsunset = {
        ...
        lib.types.submodule {
          options = {
            calendar = lib.mkOption {
              type = lib.types.str;
              description = ''
                Deprecated - Use {option}`my.services.hyprsunset.settings` instead to manage
                transitions.
            ...
            requests = lib.mkOption {
              ...
              description = ''
                ...
                List of requests to pass to `hyprctl hyprsunset` for this transition. Each
                inner list represents a separate command.
              '';
    ...
    settings = lib.mkOption {
      ...
      default = { };
      description = ''
        Hyprsunset configuration written in Nix.

        Entries with the same key should be written as lists. Variables' and colors' names
        should be quoted.
      '';
      example = lib.literalExpression ''
        {
  ...
  config = lib.mkIf cfg.enable {
    assertions = [
      {
        ...
        message = ''
          Can't set my.services.hyprsunset.enable when using the deprecated option
          my.services.hyprsunset.transitions if wayland.windowManager.hyprland.package is set
          to null.
        '';
      }
    ];
    ...
    warnings = lib.mkIf (cfg.transitions != { }) [
      ''
        Using my.services.hyprsunset.transitions is deprecated. Please use
        my.services.hyprsunset.settings instead.
      ''
    ];
          ...
          lib.nameValuePair "hyprsunset-${name}" {
            ...
            Service = {
              ...
              ExecStart = lib.concatMapStringsSep " && " (
                ...
                + "hyprsunset ${lib.escapeShellArgs cmd}"
